...
class TaskC3 {
    ...
    public static double getWeight(int weight) {
        ...
        double ears = 9.81;
//        double y = (mars/ears);
//        double roundIs =(Math.round((mars/ears)*10000)/10000d);
//        System.out.println(roundIs);


        double result = (int) ((weight * (Math.round((mars/ears)*10000)/10000d))*100);
        return result / 100;


//        double marsWeight = ((int)(weight * (((int)((mars / ears)*1000)+0.5)/10)));
//        return marsWeight/100;
