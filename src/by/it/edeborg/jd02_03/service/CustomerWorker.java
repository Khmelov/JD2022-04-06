...
import by.it.edeborg.jd02_03.interfaces.CustomerAction;
import by.it.edeborg.jd02_03.interfaces.ShoppingCardAction;
...
public class CustomerWorker extends Thread implements CustomerAction, ShoppingCardAction {
    ...
    public SomethingGood chooseGood() {
        ...
        SomethingGood good = new SomethingGood(shop.getRepository().getGoodsList().get(indexRandomGood));
    ...
    @Override
    public int putToCart(SomethingGood good) {
