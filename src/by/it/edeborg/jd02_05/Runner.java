package by.it.edeborg.jd02_05;


import by.it.edeborg.jd02_05.constants.Message;
import by.it.edeborg.jd02_05.constants.User;
        ...
        while (sc.hasNext()) {
            ...
            switch (field) {
                ...
                case "Hello":
                    ...
                    printCurrentMessage(ResMan.INSTANSE);
                    break;
            }
        }
    }
