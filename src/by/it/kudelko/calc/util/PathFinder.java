package by.it.kudelko.calc.util;

import by.it.kudelko.jd01_14.TaskA;
...
public class PathFinder {
    public static String getPath(Class<?> aClass, String fileName){
        ...
        String relationPath = aClass.getName().replace(aClass.getSimpleName(), "").replace(".", File.separator);
