...
public class Summator {
    ...
    public static Matrix addMatrixToMatrix(Matrix leftMatrix, Matrix rightMatrix) {
    ...
    public static Matrix addScalarToMatrix(Matrix matrix, Scalar scalar) {
    ...
    public static Vector addVectorToVector(Vector leftVector, Vector rightVector) {
    ...
    public static Vector addScalarToVector(Vector vector, Scalar scalar) {
    ...
    public static Scalar addScalarToScalar(Scalar leftScalar, Scalar rightScalar) {
